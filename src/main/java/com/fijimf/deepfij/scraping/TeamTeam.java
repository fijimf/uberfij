 ...
 */
    ...
    public TeamTeam(String id, String slug, String abbreviation, String displayName, String shortDisplayName, String name, String nickname, String color, String alternateColor, TeamLogo[] logos) {
        this.id = id;
        this.slug = slug;
