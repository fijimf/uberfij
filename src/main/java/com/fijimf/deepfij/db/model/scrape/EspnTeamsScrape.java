...
public class EspnTeamsScrape {
    ...
    public EspnTeamsScrape(long id, String url, LocalDateTime retrievedAt, Long responseTimeMs, Integer responseCode, String response, String digest, String status) {
        this.id = id;
        this.url = url;
