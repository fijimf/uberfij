...
import static com.fijimf.deepfij.analytics.Points.GameMetric.values;
...
public class PointsTest {
    ...
    void testCalculate() {
        ...
        SortedMap<LocalDate, Map<DailyTeamStatisticSummary, List<DailyTeamStatistic>>> result = Points.calculate(season);
        ...
        Map<String, Map<String, Map<LocalDate, Double>>> testCases =
                Map.of("POINTS_FOR_MEAN",
                        Map.of(
//                                "georgetown-hoyas",
//                                Map.of(
//                                        LocalDate.of(2022, 11, 30), 84.0,
//                                        LocalDate.of(2022, 12, 25), 85.0,
//                                        LocalDate.of(2023, 2, 5), 86.0,
//                                        LocalDate.of(2023, 3, 31), 87.0),
                                "virginia-cavaliers",
                                Map.of(
                                        LocalDate.of(2022, 11, 30), 76.667,
                                        LocalDate.of(2022, 12, 25), 70.200,
                                        LocalDate.of(2023, 2, 5), 70.450,
                                        LocalDate.of(2023, 3, 31), 67.781)
                        ),
                        "MARGIN_MEAN",
                        Map.of(
//                                "georgetown-hoyas",
...
//                                        LocalDate.of(2023, 3, 31), 24.0),
                                "virginia-cavaliers",
                                Map.of(
                                        LocalDate.of(2022, 11, 30), 17.333,
                                        LocalDate.of(2022, 12, 25), 10.4,
                                        LocalDate.of(2023, 2, 5), 10.25,
                                        LocalDate.of(2023, 3, 31), 7.719)
                        ),
                        "POINTS_AGAINST_MIN",
                        Map.of(
//                                "georgetown-hoyas",
...
//                                        LocalDate.of(2023, 3, 31), 4.0),
                                "virginia-cavaliers",
                                Map.of(
                                        LocalDate.of(2022, 11, 30), 42.0,
                                        LocalDate.of(2022, 12, 25), 42.0,
                                        LocalDate.of(2023, 2, 5), 42.0,
                                        LocalDate.of(2023, 3, 31), 42.0)
                        )
                );
        ...
        testCases.forEach((stat, map) -> {
            map.forEach((team, dateMap) -> {
                dateMap.forEach((date, value) -> {
                    ...
                    assertThat(dailyStatistic.getValue()).as(stat + "  " + team + "   " + date + "    " + value).isEqualTo(value, Offset.offset(0.001));
